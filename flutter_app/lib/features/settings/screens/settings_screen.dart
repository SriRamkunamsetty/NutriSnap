                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: const Row(
                        ...
                        children: [
                          Icon(LucideIcons.shieldCheck, color: Color(0xFF059669), size: 13),
                          SizedBox(width: 4),
                          Text('100% On-Device Data Privacy', style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: Color(0xFF065F46))),
                        ],
                      ),
                    ),
                    const SizedBox(height: 16),
